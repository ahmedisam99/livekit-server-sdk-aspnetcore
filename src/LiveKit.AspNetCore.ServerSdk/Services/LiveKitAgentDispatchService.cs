...
public sealed class LiveKitAgentDispatchService : TwirpClient, ILiveKitAgentDispatchService
{
    ...
    {
        return await MakeRequestAsync<AgentDispatch>("CreateDispatch", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<AgentDispatch>("DeleteDispatch", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<ListAgentDispatchResponse>("ListDispatch", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
}
