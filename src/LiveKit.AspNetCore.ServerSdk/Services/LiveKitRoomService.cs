...
public sealed class LiveKitRoomService : TwirpClient, ILiveKitRoomService
{
    ...
    {
        return await MakeRequestAsync<Room>("CreateRoom", request.Name, request, cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public async Task<ListRoomsResponse> ListRoomsAsync(ListRoomsRequest request, CancellationToken cancellationToken = default)
    {
        return await MakeRequestAsync<ListRoomsResponse>("ListRooms", null, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<DeleteRoomResponse>("DeleteRoom", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<ListParticipantsResponse>("ListParticipants", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<ParticipantInfo>("GetParticipant", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<RemoveParticipantResponse>("RemoveParticipant", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<MuteRoomTrackResponse>("MutePublishedTrack", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<ParticipantInfo>("UpdateParticipant", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    public async Task<UpdateSubscriptionsResponse> UpdateSubscriptionsAsync(UpdateSubscriptionsRequest request,
        CancellationToken cancellationToken = default)
    {
        return await MakeRequestAsync<UpdateSubscriptionsResponse>("UpdateSubscriptions", request.Room, request, cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public async Task<SendDataResponse> SendDataAsync(SendDataRequest request, CancellationToken cancellationToken = default)
    {
        return await MakeRequestAsync<SendDataResponse>("SendData", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<Room>("UpdateRoomMetadata", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    public async Task<ForwardParticipantResponse> ForwardParticipantAsync(ForwardParticipantRequest request,
        CancellationToken cancellationToken = default)
    {
        return await MakeRequestAsync<ForwardParticipantResponse>("ForwardParticipant", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<MoveParticipantResponse>("MoveParticipant", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<PerformRpcResponse>("PerformRpc", request.Room, request, cancellationToken).ConfigureAwait(false);
    }
}
