...
public sealed class LiveKitEgressService : TwirpClient, ILiveKitEgressService
{
    ...
    {
        return await MakeRequestAsync<EgressInfo>("StartWebEgress", null, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<EgressInfo>("StartParticipantEgress", request.RoomName, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<EgressInfo>("StartTrackCompositeEgress", request.RoomName, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<EgressInfo>("StartTrackEgress", request.RoomName, request, cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public async Task<EgressInfo> UpdateLayoutAsync(UpdateLayoutRequest request, CancellationToken cancellationToken = default)
    {
        return await MakeRequestAsync<EgressInfo>("UpdateLayout", null, request, cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public async Task<EgressInfo> UpdateStreamAsync(UpdateStreamRequest request, CancellationToken cancellationToken = default)
    {
        return await MakeRequestAsync<EgressInfo>("UpdateStream", null, request, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        return await MakeRequestAsync<ListEgressResponse>("ListEgress", request.RoomName, request, cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public async Task<EgressInfo> StopEgressAsync(StopEgressRequest request, CancellationToken cancellationToken = default)
    {
        return await MakeRequestAsync<EgressInfo>("StopEgress", null, request, cancellationToken).ConfigureAwait(false);
    }
}
